...
Four logical shards retain the previous 5k cohort's batching/seeds. Run one
physical process per GPU, each assigned two logical shards sequentially.
"""
import argparse
